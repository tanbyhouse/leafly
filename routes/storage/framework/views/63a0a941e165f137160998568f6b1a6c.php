<?php $__env->startSection('title', 'Detail Transaksi - Leafly'); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-leafly-cream min-h-screen pt-24 pb-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center text-gray-500 hover:text-leafly-dark mb-6 font-medium transition">
        ...
        <!-- header invoice -->
            <div class="p-8 border-b border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">ID Pesanan: <span class="font-mono font-bold text-gray-800"><?php echo e($order['id']); ?></span></p>
                </div>
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-600 space-y-2">
                        <p><span class="font-medium text-gray-800">Kurir:</span> <?php echo e($order['courier']); ?></p>
                        <p><span class="font-medium text-gray-800">No. Resi:</span> <?php echo e($order['resi']); ?></p>
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-600 space-y-2">
                        <p><span class="font-medium text-gray-800">Metode:</span> <?php echo e($order['payment_method']); ?></p>
                        <p><span class="font-medium text-gray-800">Waktu:</span> <?php echo e($order['date']); ?> 14:30 WIB</p>
                    </div>
                </div>
            </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr>
                                <td class="px-4 py-3 font-medium text-gray-800"><?php echo e($item['name']); ?></td>
                                <td class="px-4 py-3 text-center text-gray-600"><?php echo e($item['qty']); ?></td>
                                <td class="px-4 py-3 text-right text-gray-600">Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></td>
                                <td class="px-4 py-3 text-right font-bold text-gray-800">Rp <?php echo e(number_format($item['price'] * $item['qty'], 0, ',', '.')); ?></td>
                            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\leafly\resources\views/customer/orders/show.blade.php ENDPATH**/ ?>