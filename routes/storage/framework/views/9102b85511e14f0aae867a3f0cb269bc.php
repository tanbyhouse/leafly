...
<?php $__env->startSection('title', 'Checkout - Leafly'); ?>
...
<div class="bg-leafly-cream min-h-screen pt-24 pb-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3 mb-8">
            <a href="<?php echo e(route('cart.index')); ?>" class="w-10 h-10 rounded-full bg-white flex items-center justify-center text-leafly-dark shadow hover:bg-leafly-dark hover:text-white transition">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <input type="text" name="name" value="<?php echo e(Auth::check() ? Auth::user()->name : ''); ?>" class="w-full border-gray-300 rounded-lg focus:ring-leafly-green focus:border-leafly-green" required>
                            </div>
                            <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                        ...
                        <div class="space-y-4 mb-6 max-h-60 overflow-y-auto custom-scrollbar">
                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="grow">
                                    <h4 class="text-sm font-bold text-gray-800 line-clamp-1"><?php echo e($item['name']); ?></h4>
                                    <div class="flex justify-between text-xs text-gray-500 mt-1">
                                        <span><?php echo e($item['quantity']); ?>x</span>
                        ...
                        <div class="flex justify-between items-center mb-6 pt-4 border-t border-dashed border-gray-300">
                            ...
                            <span class="font-bold text-leafly-dark text-xl" id="grand-total-display">
                                Rp <?php echo e(number_format($subtotal + $adminFee + 10000, 0, ',', '.')); ?>
...
<script>
    ...
    let adminFee = <?php echo e($adminFee); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\leafly\resources\views/customer/checkout.blade.php ENDPATH**/ ?>