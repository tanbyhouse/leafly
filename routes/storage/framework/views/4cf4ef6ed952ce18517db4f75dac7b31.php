...
<?php $__env->startSection('title', 'Keranjang Belanja - Leafly'); ?>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-2/3">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-100" id="cart-container">
                        ...
                        <div class="p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center cart-item" data-price="<?php echo e($item['price']); ?>">
                            ...
                            <div class="col-span-6 flex items-center gap-4">
                                ...
                                <div class="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center shrink-0 text-leafly-green text-2xl">
                                    <i class="fa-solid <?php echo e($item['image']); ?>"></i>
                                </div>
                                
                                <div>
                                    <h3 class="font-bold text-leafly-dark text-sm md:text-base"><?php echo e($item['name']); ?></h3>
                                    <p class="text-xs text-gray-500 md:hidden">Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="col-span-2 flex justify-center">
                                <div class="flex items-center border border-gray-300 rounded-lg h-8 w-24">
                                    ...
                                    <input type="number" value="<?php echo e($item['quantity']); ?>" min="1" class="w-8 h-full text-center border-none focus:ring-0 p-0 text-sm font-bold text-leafly-dark input-qty" readonly>
                    ...
                    <div id="empty-cart-msg" class="hidden p-8 text-center text-gray-500">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" class="text-leafly-dark font-bold hover:underline text-sm mt-2 inline-block">Mulai Belanja</a>
                    </div>
                </div>

                <div class="mt-4">
                    <a href="<?php echo e(route('products.index')); ?>" class="text-leafly-dark font-medium hover:text-leafly-gold transition flex items-center gap-2 text-sm">
            ...
            <div class="w-full lg:w-1/3">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                    ...
                    <!-- checkout -->
                     <a href="<?php echo e(route('checkout.index')); ?>" class="block w-full bg-leafly-dark text-white font-bold text-center py-3 rounded-lg hover:bg-leafly-gold hover:text-leafly-dark transition duration-300 shadow-lg transform active:scale-95">
                        Checkout Sekarang
                    </a>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\leafly\resources\views/customer/cart.blade.php ENDPATH**/ ?>