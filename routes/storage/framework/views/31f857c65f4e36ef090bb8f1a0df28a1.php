<?php $__env->startSection('title', 'Leafly.id - Tanaman dan Perlengkapan Hidroponik'); ?>
...
<section id="home" 
    ...
    style="background-image: url('<?php echo e(asset('images/hero.png')); ?>');">
    ...
    <div class="relative z-10 max-w-4xl mx-auto animate-fade-in-up">
        ...
        <p class="text-lg md:text-xl mb-10 text-gray-100 leading-relaxed max-w-2xl mx-auto drop-shadow-sm">
            Temukan berbagai pilihan benih, bibit tanaman berkualitas, dan perlengkapan hidroponik untuk menciptakan taman impian Anda.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#products" class="px-8 py-3 bg-leafly-green text-leafly-dark rounded-full font-bold hover:bg-leafly-gold transition duration-300 shadow-lg">
                🌱 Lihat Katalog
            </a>
            <a href="#contact" class="px-8 py-3 border-2 border-white text-white rounded-full font-bold hover:bg-white hover:text-leafly-dark transition duration-300 backdrop-blur-sm">
                Hubungi Kami
            </a>
        </div>
    </div>
...
<section id="products" class="py-20 px-6 bg-white">
    <div class="text-center mb-12 animate-on-scroll">
        ...
        <p class="text-gray-600 mt-4 max-w-xl mx-auto">Pilihan favorit pelanggan kami untuk memulai kebun impian Anda di rumah.</p>
    </div>
        ...
        <div class="group bg-leafly-cream rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition duration-300">
            ...
            <div class="p-6 relative">
                ...
                <div class="flex justify-between items-end pt-4 border-t border-gray-200/50">
                    ...
                    <button class="bg-leafly-dark text-white w-9 h-9 rounded-full hover:bg-leafly-gold hover:text-leafly-dark transition flex items-center justify-center">
...
<section id="about" class="py-20 px-6 bg-white">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <!-- left image -->
        <div class="">
            <img src="<?php echo e(asset('images/hero.png')); ?>" alt="About Leafly" class="w-full h-80 md:h-96 object-cover rounded-2xl shadow-lg">
        </div>

        <!-- teks kanan -->
        <div class="">
            <h2 class="text-3xl font-bold text-leafly-dark mb-4">Tentang Leafly</h2>
            <p class="text-gray-700 mb-4">Leafly menghadirkan solusi berkebun modern untuk pemula sampai profesional. Kami menyediakan benih, bibit berkualitas, dan perlengkapan hidroponik dengan layanan konsultasi untuk membantu Anda dengan mudah menanam di rumah.</p>
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="inline-block px-6 py-3 bg-leafly-green text-leafly-dark rounded-full font-bold hover:bg-leafly-gold transition duration-300">Lihat Produk Kami</a>
        </div>
    </div>
</section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\leafly\resources\views/welcome.blade.php ENDPATH**/ ?>