...
<?php $__env->startSection('title', 'Riwayat Transaksi - Leafly'); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                    <div class="flex items-center gap-4 text-sm text-gray-600">
                        <span class="font-bold text-leafly-dark"><i class="fa-solid fa-receipt mr-1"></i> <?php echo e($ord['id']); ?></span>
                        <span>|</span>
                        <span><?php echo e($ord['date']); ?></span>
                    </div>
                    ...
                    ?>
                    <span class="px-3 py-1 rounded-full text-xs font-bold border <?php echo e($statusColor); ?>">
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row justify-between gap-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-800 text-sm md:text-base"><?php echo e($ord['items'][0]); ?></h3>
                                <?php if(count($ord['items']) > 1): ?>
                                    <p class="text-xs text-gray-500 mt-1">+ <?php echo e(count($ord['items']) - 1); ?> produk lainnya</p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-end justify-center">
                            ...
                            <span class="font-bold text-leafly-dark text-lg">Rp <?php echo e(number_format($ord['total'], 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
                    <a href="<?php echo e(route('orders.show', $ord['id'])); ?>" class="px-4 py-2 text-sm font-bold text-leafly-dark border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                        Lihat Detail
                    </a>
                    
                    <?php if($ord['status'] == 'Menunggu Pembayaran'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\leafly\resources\views/customer/orders/index.blade.php ENDPATH**/ ?>