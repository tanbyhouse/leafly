...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard - Leafly'); ?></title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-leafly-dark text-white flex flex-col shadow-xl fixed md:relative z-30 transition-all duration-300 transform -translate-x-full md:translate-x-0 h-full" id="sidebar">
            ...
            <nav class="grow p-4 space-y-2 overflow-y-auto custom-scrollbar">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-leafly-gold text-leafly-dark font-bold' : ''); ?>">
                ...
                <div class="relative">
                    ...
                    <div id="submenu-produk" class="hidden pl-4 mt-1 space-y-1">
                        <a href="<?php echo e(route('admin.products.index')); ?>" class="block px-4 py-2 text-sm hover:text-leafly-gold rounded-lg">• Daftar Produk</a>
                        <a href="<?php echo e(route('admin.busuk.index')); ?>" class="block px-4 py-2 text-sm hover:text-leafly-gold rounded-lg">• Produk Rusak</a>
                    </div>
                </div>
            ...
            <div class="p-4 border-t border-white/10">
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden bg-gray-50">
            ...
            <header class="h-16 bg-white shadow-sm flex items-center justify-between px-6 z-20">
                ...
                <h2 class="text-lg font-bold text-leafly-dark hidden md:block"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h2>

                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        <img src="<?php echo e(asset('images/avatar.jpg')); ?>" class="w-8 h-8 rounded-full border border-gray-200">
...
</html><?php /**PATH D:\laragon\www\leafly\resources\views/layouts/admin.blade.php ENDPATH**/ ?>