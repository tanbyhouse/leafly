...
@section('content')
    <div class="bg-leafly-cream min-h-screen pt-24 pb-12">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-2/3">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                ...
                                <div class="p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center cart-item"
                                    ...
                                    <div class="col-span-6 flex items-center gap-4">
                                        ...
                                        <form action="{{ route('cart.remove', $item->id) }}" method="POST" class="inline">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="text-gray-400 hover:text-red-500 transition btn-delete">
                                    ...
                                    <div class="col-span-2 flex justify-center">
                                        <div class="flex items-center border border-gray-300 rounded-lg h-8 w-24">
                                            ...
                                            <input type="number" value="{{ $item->jumlah }}" min="1"
                                                ...
                                                readonly>
                                            <button type="button"
                                                class="w-8 h-full bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-r-lg btn-plus">+</button>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="p-8 text-center text-gray-500">
                                    ...
                                    <a href="{{ route('products.index') }}"
                                        class="text-leafly-dark font-bold hover:underline text-sm mt-2 inline-block">Mulai
                                        Belanja</a>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <div class="mt-4">
                            <a href="{{ route('products.index') }}"
                                class="text-leafly-dark font-medium hover:text-leafly-gold transition flex items-center gap-2 text-sm">
                    ...
                    <div class="w-full lg:w-1/3">
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                            ...
                            <a href="{{ route('checkout.index') }}"
                                class="block w-full bg-leafly-dark text-white font-bold text-center py-3 rounded-lg hover:bg-leafly-gold hover:text-leafly-dark transition duration-300 shadow-lg transform active:scale-95">
                                Checkout Sekarang
                            </a>
                        </div>
                    </div>
        ...
        <div
            class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] md:hidden z-40">
            <div class="flex justify-between items-center gap-4">
                ...
                <a href="#"
                    class="bg-leafly-dark text-white font-bold py-2 px-6 rounded-lg hover:bg-leafly-gold hover:text-leafly-dark transition">
                    Checkout
                </a>
            </div>
        </div>
                ...
                $('.btn-plus').click(function () {
                    ...
                    if (val < max) {
                        $.ajax({
                            ...
                            error: function (xhr) {
                                alert(xhr.responseJSON.error || 'Gagal mengupdate keranjang');
                            }
                        });
                    }
                });
